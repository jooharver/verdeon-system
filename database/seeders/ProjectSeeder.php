...
class ProjectSeeder extends Seeder
{
    public function run(): void
    {
        ...
        */
        ...
        // Simulasi Laporan Audit untuk Project 1
        if ($auditor) {
            AuditReport::create([
                'project_version_id' => $v1->id,
                'auditor_id' => $auditor->id,
                'verified_installed_capacity_kwp' => 14850.00, // Sedikit beda dengan klaim
                'verified_annual_generation_kwh' => 21500.00,
                'baseline_emission_factor' => 0.85,
                'expected_carbon_reduction_ton_per_year' => 18.27,
                'onsite_measurement_date' => '2025-12-05',
                'audit_notes' => 'Kapasitas terverifikasi sedikit di bawah klaim karena shading parsial di pagi hari. Proyek sangat layak dan disetujui.',
            ]);
        }
